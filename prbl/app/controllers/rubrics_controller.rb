class RubricsController < ApplicationController
  ...
  def new
    @rubric = Rubric.new
    @criterium = @rubric.criteria.build
  end
  ...
  private
    ...
    def rubric_params
      params.require(:rubric).permit(:name, :purpose_assessment, :project_id,
        criteria_attributes: [:name, :bellow_standard, :approaching_standard, :meeting_standard])
    end
end
